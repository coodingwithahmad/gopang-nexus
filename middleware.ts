 ...
 *
 * Route protection here is defense-in-depth. Individual pages and Server Actions
 * must also verify auth independently.
 */
export async function middleware(request: NextRequest) {
  ...
  // Refresh session — MUST use getUser() not getSession() for auth decisions
  const {
    data: { user },
